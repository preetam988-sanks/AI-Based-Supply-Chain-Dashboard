                ...
                data.map((item, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right font-semibold">
                        {item.recommended_order_size || item.predicted_qty || item.quantity || item.value || 0}
                      </td>
        ...
        <div className="p-6 lg:p-10 space-y-8 border-r border-zinc-200 dark:border-zinc-800">
          ...
          {result && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                {/* KPI Cards for Summary Intents */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {(result.forecast_30d_total || (intent === "FORECAST" && result.forecast_30d_total)) && (
                  ...
                  AI Strategy Insight
                    ...
                    <div className="text-zinc-800 dark:text-zinc-200 leading-relaxed text-lg font-medium italic">
                      {typeof result === "string"
                          ...
                          : result.message ||
                          result.summary ||
                          (result.total_orders ? `Found ${result.total_orders} historical records for this analysis.` : "Analysis report generated successfully.")}
                    </div>
                  </div>
                </div>

                {/* List Components for Specialized Analysis */}
                <div className="space-y-8">
                  ...
                  {/* standard top/least performant lists */}
